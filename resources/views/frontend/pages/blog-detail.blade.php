            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12"data-aos="fade-up">
                    <div class="main-sidebar">
                        ...
                        <!--/ End Single Widget -->
                        <!-- Single Widget -->
                        <div class="single-widget category"data-aos="fade-up">
                            <h3 class="title">Blog Categories</h3>
                            <ul class="categor-list">
                                {{-- {{count(Helper::postCategoryList())}} --}}
                                @foreach(app\Http\Helpers::postCategoryList('posts') as $cat)
                        ...
                        <!--/ End Single Widget -->
                        <!-- Single Widget -->
                        <div class="single-widget recent-post"data-aos="fade-up">
                        ...
                        <!--/ End Single Widget -->
                        <!-- Single Widget -->
                        <div class="single-widget side-tags"data-aos="fade-up">
                            <h3 class="title">Tags</h3>
                            <ul class="tag">
                                @foreach(app\Http\Helpers::postTagList('posts') as $tag)
                        ...
                        <!--/ End Single Widget -->
                        <!-- Single Widget -->
                        <div class="single-widget newsletter"data-aos="fade-up">

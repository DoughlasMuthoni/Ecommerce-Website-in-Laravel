					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{\App\Http\Helpers::totalCartPrice()}}">Cart Subtotal<span>Ksh{{number_format(\App\Http\Helpers::totalCartPrice(),2)}}</span></li>
